...
const STRINGS: Record<string, Entry> = {
  ...
  'party.leaveHere': { en: 'Leave it living here', es: 'Dejarlo viviendo aquí' },
  'party.leaveHereHint': {
    en: 'It leaves your party and lives in this house until you pick it up.',
    es: 'Sale de tu equipo y vive en esta casa hasta que lo recojas.'
  },
  ...
  'house.action.close': { en: 'Close', es: 'Cerrar' },
  'house.window.loading': { en: 'Loading…', es: 'Cargando…' },
  'house.window.pickApartment': { en: 'Pick an apartment', es: 'Elige un apartamento' },
  'house.window.hint': { en: '↑↓ move · Enter choose · Esc back', es: '↑↓ mover · Enter elegir · Esc volver' },
  'house.chip.free': { en: 'Free', es: 'Libre' },
  'house.chip.yours': { en: 'Yours', es: 'Tuya' },
  'house.chip.owned': { en: 'Taken', es: 'Ocupada' },
  'house.chip.forSale': { en: 'For sale', es: 'En venta' },
  'house.chip.unavailable': { en: 'N/A', es: 'N/D' },
  ...
  'house.action.settings': { en: 'House settings', es: 'Ajustes de la casa' },
  'house.action.pets': { en: 'Venomons at home', es: 'Venomons en casa' },
  // --- House pets ---
  'pet.title': { en: 'Venomons at home', es: 'Venomons en casa' },
  'pet.window.hint': { en: 'They live here while you are away. Feed them, play and pet them.', es: 'Viven aquí mientras no estás. Aliméntalos, juega y mímalos.' },
  'pet.window.empty': { en: 'No venomon lives here. Leave one from your party window.', es: 'Aquí no vive ningún venomon. Deja uno desde la ventana de equipo.' },
  'pet.owner': { en: 'Owner: {name}', es: 'Dueño: {name}' },
  'pet.yours': { en: 'Yours', es: 'Tuyo' },
  'pet.need.hunger': { en: 'Hunger', es: 'Hambre' },
  'pet.need.boredom': { en: 'Boredom', es: 'Aburrimiento' },
  'pet.need.loneliness': { en: 'Loneliness', es: 'Soledad' },
  'pet.need.mood': { en: 'Mood', es: 'Ánimo' },
  'pet.state.sick': { en: '🤢 sick', es: '🤢 enfermo' },
  'pet.state.courting': { en: '❤️ in love', es: '❤️ enamorado' },
  'pet.state.egg': { en: '🥚 expecting an egg', es: '🥚 esperando un huevo' },
  'pet.state.happy': { en: '😊 happy', es: '😊 feliz' },
  'pet.state.hungry': { en: '🍽️ hungry', es: '🍽️ hambriento' },
  'pet.state.bored': { en: '😴 bored', es: '😴 aburrido' },
  'pet.state.lonely': { en: '💔 lonely', es: '💔 solo' },
  'pet.action.feed': { en: 'Feed', es: 'Alimentar' },
  'pet.action.play': { en: 'Play (ball)', es: 'Jugar (pelota)' },
  'pet.action.caress': { en: 'Pet it', es: 'Acariciar' },
  'pet.action.take': { en: 'Take it back to the party', es: 'Volver al equipo' },
  'pet.action.clean': { en: 'Clean up the mess of {name}', es: 'Limpiar el vómito de {name}' },
  'pet.action.collectEgg': { en: 'Collect the egg of {name}', es: 'Recoger el huevo de {name}' },
  'pet.action.eggNotYours': { en: 'Egg of {name} (not yours)', es: 'Huevo de {name} (no es tuyo)' },
  'pet.feed.title': { en: 'Pick a berry', es: 'Elige una baya' },
  'pet.feed.empty': { en: 'You have no berries. Pets eat berries.', es: 'No tienes bayas. Los venomons comen bayas.' },
  'pet.floor.title': { en: 'On the floor', es: 'En el suelo' },
  'pet.msg.left': { en: '{name} now lives here.', es: '{name} ahora vive aquí.' },
  'pet.msg.taken': { en: '{name} is back in your party.', es: '{name} vuelve a tu equipo.' },
  'pet.msg.fed': { en: '{name} ate the {item}.', es: '{name} se comió la {item}.' },
  'pet.msg.playing': { en: '{name} is playing!', es: '¡{name} está jugando!' },
  'pet.msg.caressed': { en: '{name} loves it.', es: 'A {name} le encanta.' },
  'pet.msg.cleaned': { en: 'All clean.', es: 'Todo limpio.' },
  'pet.msg.eggCollected': { en: 'You got the egg of {name}!', es: '¡Tienes el huevo de {name}!' },
  'pet.reason.houseFull': { en: 'Too many venomons live here already.', es: 'Ya viven demasiados venomons aquí.' },
  'pet.reason.notInParty': { en: 'That venomon is not in your party.', es: 'Ese venomon no está en tu equipo.' },
  'pet.reason.egg': { en: 'An egg cannot live on its own.', es: 'Un huevo no puede vivir solo.' },
  'pet.reason.lastVenomon': { en: 'You must keep at least one venomon with you.', es: 'Debes llevar al menos un venomon contigo.' },
  'pet.reason.noSprite': { en: 'That venomon cannot walk around here.', es: 'Ese venomon no puede pasear por aquí.' },
  'pet.reason.noPet': { en: 'That venomon does not live here.', es: 'Ese venomon no vive aquí.' },
  'pet.reason.notYours': { en: 'That venomon is not yours.', es: 'Ese venomon no es tuyo.' },
  'pet.reason.partyFull': { en: 'Your party is full.', es: 'Tu equipo está lleno.' },
  'pet.reason.notFood': { en: 'Pets only eat berries.', es: 'Los venomons solo comen bayas.' },
  'pet.reason.tooSoon': { en: 'Give it a moment.', es: 'Dale un momento.' },
  'pet.reason.noRoomForBall': { en: 'No room for the ball.', es: 'No hay espacio para la pelota.' },
  'pet.reason.noGround': { en: 'There is nothing there.', es: 'Ahí no hay nada.' },
  'pet.reason.notYourEgg': { en: 'That egg belongs to someone else.', es: 'Ese huevo es de otra persona.' },
  'social.petAlert': { en: '🐾 {text}', es: '🐾 {text}' },
  'social.native.pet': { en: '{text}', es: '{text}' },
