...
export type PokemonSummary = {
  ...
  name: string
  nickname?: string
  /** ♂ / ♀ / genderless — persisted per individual by the server. */
...
type AuthContextValue = {
  ...
  /** Leaves a party venomon living in the house the player stands in (pets). */
  leavePetInHouse: (payload: { pokemonId: string }) => void
...
export const AuthProvider = (
  ...
  const value = useMemo<AuthContextValue>(() => ({
    ...
    leavePetInHouse: (payload) => emitAuthEvent('house:pet-leave', payload),
