...
- Skip the Chrisanta intro autorun (it blocks the new-user screen): `docker exec redis-dev redis-cli hset auth:user:<id> event_self_switches '{"129:2:A":true}'` BEFORE the user's first `addPlayer`.
